...
export default function release() {
  return (
    <>
      ...
      <p className="my-7">
        Paola Marinho, Felipe Campos, Fábio Tavares, Guilherme Braun e Rafael Guerlak, não são apenas músicos talentosos,
        mas amigos de longa data.
        A história da banda começou de forma despretensiosa, os amigos se uniram para tocar no casamento da Paola e a brincadeira
        se tornou um dos pontos altos da festa! De lá para cá e depois de muitos feedbacks positivos, os amigos decidiram
        transformar a brincadeira em coisa séria,
